const MobileSearchButton = ({ onClick, label }) => {
  return (
    <div className='flex items-center flex-1 p-2 truncate md:hidden' onClick={onClick}>
      ...
      <div className='flex-1 text-sm leading-relaxed text-left truncate'>{label}</div>
    </div>
  );
};
